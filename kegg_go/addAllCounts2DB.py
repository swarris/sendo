...
session.run("match (a:GOTerm) where a.ChytObl and not a.ChytCult and not a.CtrlCult and a.CtrlObl set a.group ='{}'".format("noChytObl"))
...
session.run("match (a:GOTerm) where a.allChytObl and not a.allChytCult and not a.allCtrlCult and a.allCtrlObl set a.allgroup ='{}'".format("noChytObl"))
